...
(def ^:large-vars/data-var dicts
  {:en {:tutorial/text #?(:cljs (rc/inline "tutorial-en.md")
   ...
   :tr {:tutorial/text #?(:cljs (rc/inline "tutorial-tr.md")
      ...
      :nl {:tutorial/text #?(:cljs (rc/inline "tutorial-en.md")
                          :default "tutorial-en.md")
        :tutorial/dummy-notes #?(:cljs (rc/inline "dummy-notes-en.md")
                                 :default "dummy-notes-en.md")
        :help/start "Getting started"
        ...
        :search/items "items"
        :search/page-names "Doorzoek paginas"
        :help/context-menu "Block context menu"
        :help/fold-unfold "Fold/unfold blocks (when not in edit mode)"
        :help/markdown-syntax "Markdown syntax"
        :help/org-mode-syntax "Org mode syntax"
        ...
        :right-side-bar/block-ref "Block references"
        :right-side-bar/graph-view "Graph view"
        :right-side-bar/all-pages "Alle paginas"
        :right-side-bar/flashcards "Flashcards"
        :right-side-bar/new-page "Nieuwe pagina"
        :left-side-bar/journals "Dagboek"
        :left-side-bar/new-page "Nieuwe pagina"
        :left-side-bar/nav-favorites "Favorieten"
        :left-side-bar/nav-shortcuts "Shortcuts"
        :left-side-bar/nav-recent-pages "Recent"
        :format/preferred-mode "Wat is jouw favorite modus?"
        :format/markdown "Markdown"
        :format/org-mode "Org mode"
        :reference/linked "Linked reference"
        :reference/unlinked-ref "Unlinked references"
        :page/presentation-mode "Presentatie"
        :page/edit-properties-placeholder "Eigenschappen"
        :page/delete-success "Pagina {1} is succesvol verwijderd!"
        :page/delete-confirmation "Weet je zeker dat je deze pagina en bijbehorende bestand wil verwijderen?"
        :page/rename-to "Hernoem \"{1}\" naar:"
        :page/priority "Prioriteit \"{1}\""
        :page/copy-to-json "Kopieer de hele pagina als JSON"
        :page/rename "Pagina hernoemen"
        :page/open-in-finder "Open in map"
        :page/open-with-default-app "Open met standaard app"
        :page/action-publish "Publiceren"
        :page/make-public "Publiek maken om te publiceren?"
        :page/version-history "Bekijk geschiedenis van pagina"
        :page/open-backup-directory "Open page backups directory"
        :page/file-sync-versions "Page versions"
        :page/make-private "Make it private"
        :page/delete "Delete page"
